...
export const EIPDiffsPerMonthChart = ({ category, eipDiffs, eipDiffsPerMonth, lastCallEIPs }: CategoryProps) => {
...
export const LatestEIPTable = ({ category, eipDiffs, eipDiffsPerMonth, lastCallEIPs }: CategoryProps) => {
    return (
...
export const EIPsInLastCallTable = ({ category, eipDiffs, eipDiffsPerMonth, lastCallEIPs }: CategoryProps) => {
    return (
        <div className="max-w-7xl mx-auto">
    ...
    return (
        <Layout>
            <div className="mx-auto max-w-[1216px]">
                ...
                <EIPDiffsPerMonthChart category={category} eipDiffs={eipDiffs} eipDiffsPerMonth={eipDiffsPerMonth} lastCallEIPs={lastCallEIPs} />
            </div>
